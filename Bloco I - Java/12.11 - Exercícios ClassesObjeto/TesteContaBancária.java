package exercicioclassesobjetos6;

public class TesteContaBancária {
	...
	public static void main(String[] args) {
		...
		ContaBancária c2 = new ContaBancária();
		ContaBancária c3 = new ContaBancária();
		ContaBancária loginc = new ContaBancária();
